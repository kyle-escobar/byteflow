...
package dev.kyleescobar.byteflow.optimize;

import java.io.*;
import java.text.*;
import java.util.*;

import dev.kyleescobar.byteflow.cfg.*;
import dev.kyleescobar.byteflow.codegen.*;
import dev.kyleescobar.byteflow.context.*;
import dev.kyleescobar.byteflow.diva.*;
import dev.kyleescobar.byteflow.editor.*;
import dev.kyleescobar.byteflow.file.*;
import dev.kyleescobar.byteflow.inline.*;
import dev.kyleescobar.byteflow.reflect.*;
import dev.kyleescobar.byteflow.ssa.*;
import dev.kyleescobar.byteflow.tbaa.*;
import dev.kyleescobar.byteflow.trans.*;
import dev.kyleescobar.byteflow.tree.*;
import dev.kyleescobar.byteflow.cfg.DominatorTree;
import dev.kyleescobar.byteflow.cfg.FlowGraph;
import dev.kyleescobar.byteflow.cfg.VerifyCFG;
import dev.kyleescobar.byteflow.codegen.CodeGenerator;
import dev.kyleescobar.byteflow.codegen.Liveness;
import dev.kyleescobar.byteflow.codegen.RegisterAllocator;
import dev.kyleescobar.byteflow.context.BloatContext;
import dev.kyleescobar.byteflow.context.CachingBloatContext;
import dev.kyleescobar.byteflow.diva.InductionVarAnalyzer;
import dev.kyleescobar.byteflow.editor.*;
import dev.kyleescobar.byteflow.file.ClassFile;
import dev.kyleescobar.byteflow.file.ClassFileLoader;
import dev.kyleescobar.byteflow.inline.StackHeightCounter;
import dev.kyleescobar.byteflow.reflect.ClassFormatException;
import dev.kyleescobar.byteflow.reflect.MethodInfo;
import dev.kyleescobar.byteflow.ssa.SSA;
import dev.kyleescobar.byteflow.ssa.SSAGraph;
import dev.kyleescobar.byteflow.tbaa.TypeInference;
import dev.kyleescobar.byteflow.trans.*;
import dev.kyleescobar.byteflow.tree.StackOptimizer;
import dev.kyleescobar.byteflow.tree.Tree;

/**
 * Usage: java dev.kyleescobar.byteflow.optimize.Main [-options] classes dir
 * 
...
public class Main {
	...
	private static void usage() {
		System.err
				.println("\nUsage: java dev.kyleescobar.byteflow.optimize.Main"
						+ "\n            [-options] classes dir"
						+ "\n"
	...
	private static void editClass(final String className) {
		...
		if (Main.ANNO) {
			String s = "Optimized with: dev.kyleescobar.byteflow.optimize.Main";
