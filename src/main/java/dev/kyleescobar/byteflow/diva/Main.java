...
package dev.kyleescobar.byteflow.diva;
 ...
 * does.
 * 
 * @see dev.kyleescobar.byteflow.optimize.Main
 */
public class Main {
	...
	private static void usage() {
		System.err
				.println("Usage: java dev.kyleescobar.byteflow.optimize.Main"
						+ "\n            [-options] classes dir"
						+ "\n"
	...
	private static void editClass(final String className) {
		...
		if (Main.ANNO) {
			String s = "Optimized with: dev.kyleescobar.byteflow.diva.Main";
