...
import dev.kyleescobar.byteflow.reflect.Constant;
...
import dev.kyleescobar.byteflow.util.Graph;
import dev.kyleescobar.byteflow.util.GraphNode;
...
public class ClassHierarchy {
	...
	private void addClass(final String name) {
		 ...
		 * 
		 * dev.kyleescobar.byteflow.depend.TypeNode typeNode =
