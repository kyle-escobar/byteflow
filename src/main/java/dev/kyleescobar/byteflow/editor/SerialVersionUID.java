...
package dev.kyleescobar.byteflow.editor;
...
import dev.kyleescobar.byteflow.reflect.ClassInfoLoader;
...
public class SerialVersionUID {
	...
	public static boolean implementsSerializable(final ClassEditor ce) {
		if (ce.type().equals(dev.kyleescobar.byteflow.editor.Type.OBJECT)) {
			// Stop the recursion!
			return (false);
		}

		final dev.kyleescobar.byteflow.editor.Type serializable = dev.kyleescobar.byteflow.editor.Type.getType("Ljava/io/Serializable;");
		final dev.kyleescobar.byteflow.editor.Type[] interfaces = ce.interfaces();
		...
		final dev.kyleescobar.byteflow.editor.Type superclass = ce.superclass();
